...
const { UptimeKumaServer } = require("../Thamrin-Monitoring-server");
    ...
    start(io) {
                ...
                if (await Monitor.isUnderMaintenance(this.id)) {
                    ...
                    const options = {
                        ...
                        headers: {
                            ...
                            "User-Agent": "Thamrin-Monitoring/" + version,
                    ...
                    bean.msg = await kafkaProducerAsync(
                        ...
                        this.kafkaProducerMessage,
                        {
                            ...
                            clientId: `Thamrin-Monitoring/${version}`,
                            interval: this.interval,
                        },
        ...
        const safeBeat = async () => {
            try {
                ...
                log.error("monitor", "Please report to https://github.com/louislam/Thamrin-Monitoring/issues");
